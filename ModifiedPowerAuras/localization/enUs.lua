...
MPOWA_CONFIGFRAME_NAME = "Aura Configuration"
...
MPOWA_SLIDER_STANCE = "Stance: "
MPOWA_SLIDER_STANCE_TOOLTIP = "Move this to change the stance number to match (1=Battle, 2=Defensive,3=Berserker)"
